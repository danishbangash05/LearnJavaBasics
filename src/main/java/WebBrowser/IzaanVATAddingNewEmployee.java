...
public class IzaanVATAddingNewEmployee {
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            // Creating an class for maximizing the screen
            ...
            driver.findElement(By.id("employeeCode")).sendKeys("emp-005");
            ...
            driver.findElement(By.id("nameEnglish")).sendKeys("Jalal-ud-din  Akbar");
